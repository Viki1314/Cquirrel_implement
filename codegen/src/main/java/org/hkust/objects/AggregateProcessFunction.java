...
public class AggregateProcessFunction extends ProcessFunction {
    ...
    public AggregateProcessFunction(String name //"QAggregate0ProcessFunction"
                                    , List<String> thisKey //Array("ORDERKEY","O_ORDERDATE","O_SHIPPRIORITY")
                                    , List<String> outputKey //Array("ORDERKEY","O_ORDERDATE","O_SHIPPRIORITY")
                                    , List<AggregateValue> aggregateValues,
