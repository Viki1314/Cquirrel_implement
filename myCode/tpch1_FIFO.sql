...
LOAD DATA INFILE '/mnt/e/projects/Cquirrel_implement/resource/tpch/1/window_data/nation_window.tbl'
INTO TABLE nation
...
LOAD DATA INFILE '/mnt/e/projects/Cquirrel_implement/resource/tpch/1/window_data/customer_window.tbl'
INTO TABLE customer
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/mnt/e/projects/Cquirrel_implement/resource/tpch/1/window_data/orders_window.tbl'
INTO TABLE orders
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/mnt/e/projects/Cquirrel_implement/resource/tpch/1/window_data/lineitem_window.tbl'
INTO TABLE lineitem
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
